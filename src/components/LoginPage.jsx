  ...
  return (
    <div style={{
      ...
      <div className="bounce-in" style={{
        ...
        borderRadius: 28,
        boxShadow: '0 40px 80px rgba(0,0,0,0.5), 0 0 0 1px rgba(56,189,248,0.1)',
        ...
        <div style={{
          ...
          <i className="fas fa-layer-group" style={{ color: '#fff', fontSize: 32 }} />
        </div>

        {/* Title */}
        <h1 className="gradient-text" style={{ fontSize: 32, fontWeight: 900, marginBottom: 8, letterSpacing: '-0.03em' }}>
          PaperPulse
        </h1>
        <p style={{ fontSize: 14, color: 'var(--text-muted)', marginBottom: 36, lineHeight: 1.6 }}>
          AI-Based Intelligent Research Paper Recommendation<br />
          and Literature Survey Assistant
        </p>

        {/* Feature pills */}
        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: 8, marginBottom: 36 }}>
          {[
            { icon: 'fa-lightbulb',  label: 'Paper Recommendation' },
            { icon: 'fa-book-open',  label: 'Literature Survey' },
