          ...
          {noHistory && (
            <div className="fade-in-up" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', textAlign: 'center', gap: 16 }}>
              <div style={{
                ...
                boxShadow: '0 0 45px rgba(14,165,233,0.45)',
                animation: 'pulse-glow 2.5s infinite',
              }}>
                <i className="fas fa-layer-group" />
              </div>
              <div>
                <h2 className="gradient-text" style={{ fontSize: 28, fontWeight: 900, marginBottom: 8 }}>Research Assistant</h2>
                <p style={{ color: 'var(--text-muted)', fontSize: 14, maxWidth: 380, lineHeight: 1.6 }}>
                  {session.docs.length === 0
                    ? 'Upload your research papers to begin AI-powered analysis, recommendations, and literature survey assistance.'
                    : 'Your papers are indexed and ready. Ask anything about your research library.'}
                </p>
              </div>
